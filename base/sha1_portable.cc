...
std::string SHA1HashStringBase16(const std::string& str) {
  ...
  std::string ret;
  ret.resize(SecureHashAlgorithm::kDigestSizeBytes * 2);

  int j = 0;
  for (int i = 0; i < SecureHashAlgorithm::kDigestSizeBytes; i ++) {
    int a = hash[i];
